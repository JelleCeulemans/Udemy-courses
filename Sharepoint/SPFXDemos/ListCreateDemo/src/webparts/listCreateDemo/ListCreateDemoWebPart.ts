...
import styles from './ListCreateDemoWebPart.module.scss';
import * as strings from 'ListCreateDemoWebPartStrings';
import { SPHttpClient, SPHttpClientResponse, ISPHttpClientOptions } from '@microsoft/sp-http';

export interface IListCreateDemoWebPartProps {
  description: string;
}

export default class ListCreateDemoWebPart extends BaseClientSideWebPart<IListCreateDemoWebPartProps> {
